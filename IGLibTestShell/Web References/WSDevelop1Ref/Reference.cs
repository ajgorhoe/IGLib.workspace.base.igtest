...
namespace IG.Lib.WSDevelop1Ref {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="WSDevelop1Soap", Namespace="http://www2.arnes.si/~ljc3m2/igor/iglib/")]
    public partial class WSDevelop1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback TestMethodWS2OperationCompleted;
        
        private System.Threading.SendOrPostCallback ReturnClientTableOperationCompleted;
        ...
        /// <remarks/>
        public WSDevelop1() {
            this.Url = global::IG.Lib.Properties.Settings.Default.igs_WSDevelop1Ref_WSDevelop1;
        ...
        /// <remarks/>
        public event TestMethodWS2CompletedEventHandler TestMethodWS2Completed;
        
        /// <remarks/>
        public event ReturnClientTableCompletedEventHandler ReturnClientTableCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www2.arnes.si/~ljc3m2/igor/iglib/TestMethodWS2", RequestNamespace="http://www2.arnes.si/~ljc3m2/igor/iglib/", ResponseNamespace="http://www2.arnes.si/~ljc3m2/igor/iglib/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string TestMethodWS2() {
            object[] results = this.Invoke("TestMethodWS2", new object[0]);
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void TestMethodWS2Async() {
            this.TestMethodWS2Async(null);
        }
        
        /// <remarks/>
        public void TestMethodWS2Async(object userState) {
            if ((this.TestMethodWS2OperationCompleted == null)) {
                this.TestMethodWS2OperationCompleted = new System.Threading.SendOrPostCallback(this.OnTestMethodWS2OperationCompleted);
            }
            this.InvokeAsync("TestMethodWS2", new object[0], this.TestMethodWS2OperationCompleted, userState);
        }
        
        private void OnTestMethodWS2OperationCompleted(object arg) {
            if ((this.TestMethodWS2Completed != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.TestMethodWS2Completed(this, new TestMethodWS2CompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www2.arnes.si/~ljc3m2/igor/iglib/ReturnClientTable", RequestNamespace="http://www2.arnes.si/~ljc3m2/igor/iglib/", ResponseNamespace="http://www2.arnes.si/~ljc3m2/igor/iglib/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string ReturnClientTable() {
            object[] results = this.Invoke("ReturnClientTable", new object[0]);
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void ReturnClientTableAsync() {
            this.ReturnClientTableAsync(null);
        }
        
        /// <remarks/>
        public void ReturnClientTableAsync(object userState) {
            if ((this.ReturnClientTableOperationCompleted == null)) {
                this.ReturnClientTableOperationCompleted = new System.Threading.SendOrPostCallback(this.OnReturnClientTableOperationCompleted);
            }
            this.InvokeAsync("ReturnClientTable", new object[0], this.ReturnClientTableOperationCompleted, userState);
        }
        
        private void OnReturnClientTableOperationCompleted(object arg) {
            if ((this.ReturnClientTableCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.ReturnClientTableCompleted(this, new ReturnClientTableCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www2.arnes.si/~ljc3m2/igor/iglib/GetClientData", RequestNamespace="http://www2.arnes.si/~ljc3m2/igor/iglib/", ResponseNamespace="http://www2.arnes.si/~ljc3m2/igor/iglib/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public ClientDataBase[] GetClientData(int Number) {
            object[] results = this.Invoke("GetClientData", new object[] {
                        Number});
            return ((ClientDataBase[])(results[0]));
        }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://www2.arnes.si/~ljc3m2/igor/iglib/")]
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1")]
    public delegate void TestMethodWS2CompletedEventHandler(object sender, TestMethodWS2CompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class TestMethodWS2CompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal TestMethodWS2CompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1")]
    public delegate void ReturnClientTableCompletedEventHandler(object sender, ReturnClientTableCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class ReturnClientTableCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal ReturnClientTableCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
    ...
    public partial class GetClientDataCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public ClientDataBase[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((ClientDataBase[])(this.results[0]));
            }
        }
    }
