...
namespace TestOpt
{
    ...
    public class IGLibShellMainProgram: ApplicationCommandlineBase
    {

        public IGLibShellMainProgram() : base()
        {
        ...
        public override void AplicationMain(string[] args)
        {
            ...
            // IGLibShellApp app = new IGLibShellApp();
            IGLibShellApp.Init();
