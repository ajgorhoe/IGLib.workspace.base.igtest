...
";
        ...
        protected string _runnableInterface = "IG.Lib.IRunnableOld";
        ...
        public void Compile()
        {
            ...
            bool useObsoleteCompiler = false;

            CompilerResults compResults = null;

            if (useObsoleteCompiler)
            {

                Console.WriteLine();
                Console.WriteLine("WARNING: an obsolete compiler is used!");
                Console.WriteLine();
