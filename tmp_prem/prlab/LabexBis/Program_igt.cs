...
namespace IGTest
{
    class ProgramIGTest
    {
        ...
        public static IReporter _rep = new ReporterConsole();
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                if (TestObservationOrder)
                {
                    ...
                    @"D:\users\igor\cvis\igcs\igtest\tmp_prem\prlab\LabexBis\schemas\testmessages\Incoming_2009_05_27_15_31_59__ID.7347013c-c86d-1004-8308-fceda6e7ba8a.xml");


                    // Šablonsko sporočilo:
                    TestMsgObservationOrder(
                         @"D:\users\igor\cvis\igcs\igtest\tmp_prem\prlab\LabexBis\schemas\SpecimenObservationOrder.xml");


                    TestMsgObservationEvent(
                        @"D:\users\igor\cvis\igcs\igtest\tmp_prem\prlab\LabexBis\schemas\SpecimenObservationEvent.xml");

                    TestMsgFinancialTransaction(
                        @"D:\users\igor\cvis\igcs\igtest\tmp_prem\prlab\LabexBis\schemas\DetailedFinancialTransaction.xml");
                ...
                bool TestNullifyObservationOrder = false;
                bool SendToCalypso = false;   // If true then the message is actually sent to the web service:

                if (TestNullifyObservationOrder)
                {
                    string InputNullify = @"D:\users\igor\cvis\igcs\igtest\tmp_prem\prlab\LabexBis\schemas\testmessages\Incoming_2009_08_12_10_48__ID.f49df78d-c907-1004-890e-885276b8b55a____bbfa9f51-8e6e-4d10-ab9e-d022a16a9fa4.xml";
                    string OutputNullify = @"D:\users\igor\cvis\igcs\igtest\tmp_prem\prlab\LabexBis\schemas\testmessages\Nullify_2009_08_12_10_13__ID.e51d21ad-c907-1004-890e-885276b8b55a____edd6daad-0ef6-44b9-9a68-18b58ccb01f8.xml";
                    ...
                    if (SendToCalypso)
                    {
                        ...
                        InputNullify = @"D:\users\igor\cvis\igcs\igtest\tmp_prem\prlab\LabexBis\schemas\testmessages\Incoming_2009_08_13_16_47__ID.719752cd-c90a-1004-890e-885276b8b55a____a2369d8b-7a72-45db-b0d8-4515d1ecce0e.xml";
