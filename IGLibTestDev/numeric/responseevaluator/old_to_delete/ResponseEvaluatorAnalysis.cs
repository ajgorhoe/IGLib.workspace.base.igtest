...
namespace IG.NumExperimental
{
        ...
        ILockable
    {
        ...
        protected override AnalysisResults CreateRequestThis(IVector parameters)
        {
            AnalysisResults ret = new AnalysisResults();
            // Copy problem characteristics:
            ret.NumParameters = this.NumParameters;
            ret.NumObjectives = this.NumObjectives;
            ret.NumConstraints = this.NumConstraints;
            ret.NumEqualityConstraints = this.NumEqualityConstraints;
            // Copy request flags:
            ret.ReqObjective = this.ReqObjective;
            ret.ReqConstraints = this.ReqConstraints;
            ret.ReqObjectiveGradient = this.ReqObjectiveGradient;
            ret.ReqConstraintGradients = this.ReqConstraintGradients;
            ret.ReqObjectiveHessian = this.ReqObjectiveHessian;
            ret.ReqConstraintHessians = this.ReqConstraintHessians;
            // Copy parameters:
