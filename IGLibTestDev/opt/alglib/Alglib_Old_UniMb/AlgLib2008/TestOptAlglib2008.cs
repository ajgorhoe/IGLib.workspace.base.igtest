...
namespace IG.Num
{
    ...
    public class TestAlgLibBase2008
    {
    ...
    /// $A Igor Apr08;
    public class TestAlglibOld2008 : TestAlgLibBase2008
    {
        ...
        public void TestLbfgsAlglibOld()
        {
            ...
            int maxits = 0;
            int flags = 0;
            AlgLib.lbfgs.lbfgsstate state = new AlgLib.lbfgs.lbfgsstate();
            ...
            AlgLib.lbfgs.minlbfgs(dim, m, ref paramTable, epsg, epsf, epsx, maxits, flags, ref state);
            ...
            while (AlgLib.lbfgs.minlbfgsiteration(ref state))
            {
        ...
        /// <remarks>The generalized Rosenbrock function is minimized.
